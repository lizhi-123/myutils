...
public class SendMail {
    ...
    public static String myEmailAccount = "17608065223@163.com";
    public static String myEmailPassword = "GPYMPVVRPNFWNEBT";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "1782072968@qq.com";

...
public class RSAUtils {
    ...
    private static String public_key="MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDbykZh8nGugR4hMUtXeQBpMFhif0JXBAzR8KCLapoXtMfO6vXrkKU1ZtBxGAg7nnyItbEkAMNB3ONQcaI4naXnfsjbs083bE9dkvtov8VeHyHM7n/0O6ULcZsFTJvP1z5Z4aifzjh4DZU3Fsw2TT2xz1k9WKibeFtOxLj21XNccQIDAQAB";
    private static String private_key = "";
    /**加密*/
    public static String encrypt(String name) throws Exception {
        return Base64Util.encryptBASE64(RSAUtils.encryptByPublicKey(name.getBytes(), public_key));
    }
    /**解密*/
    public static String decrypt(String name) throws Exception {
        return new String(RSAUtils.decryptByPrivateKey(Base64Util.decryptBASE64(name),private_key ));
    }

    public static void main(String[] args) throws Exception {
        String encrypt = RSAUtils.encrypt("18981815323");
        System.out.println("加密>>>"+encrypt);
        System.out.println(RSAUtils.decrypt(encrypt));
    }
}
